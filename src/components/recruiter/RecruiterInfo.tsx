  ...
  return (
    <section className="py-8 px-4 bg-white">
      <div className="max-w-6xl mx-auto p-2">
        ...
        {/* Description */}
        <p className="text-gray-600 leading-relaxed max-w-6xl text-base text-justify hyphens-auto mb-6">
          {tInfo("description")}
        </p>
        ...
        <div className="space-y-2">
          <div className="flex items-start">
            ...
            <p className="text-gray-600 leading-relaxed text-base text-justify hyphens-auto">
              {tInfo("bullets.b1")}
            </p>
          </div>
          <div className="flex items-start">
