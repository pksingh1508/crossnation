...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 flex items-center justify-center overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        <div className="absolute top-8 left-4 md:top-16 md:left-8 lg:top-20 lg:left-12 pointer-events-auto">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 shadow-lg border border-white/20 max-w-[200px] md:max-w-xs">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                size="lg"
                className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white px-8 py-4 text-lg font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
              >
                {t("cta")}
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-2 border-amber-500 text-amber-700 hover:bg-amber-50 px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300"
              >
                {common("contact")}
              </Button>
            </div>
