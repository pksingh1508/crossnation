...
const preArrivalServices = [
  ...
  "Pre-departure briefing about life and work in Czech Republic",
  ...
  "Basic orientation on Czech Republicn culture and rules",
...
const employmentBenefitsData = {
  title: "Advantages of Employment in Czech Republic",
  description:
    "Czech Republic continues to attract international workers because it combines practical career opportunities with a stable and affordable lifestyle.",
  items: advantages,
  icons: advantageIcons,
};

const whyApplyData = {
  title: "Why Apply for a Czech Republic Work Visa?",
  description:
    "For many international workers, Czech Republic offers a strong balance of hiring demand, legal employment pathways, and long-term growth potential.",
  items: visaReasons,
  icons: visaIcons,
};

const openRolesData = {
  title: "Top Unskilled Job Opportunities Now Open in Czech Republic",
  jobs: unskilledJobs,
...
const paymentChargePolicyData = {
  ...
  installments: [
    ...
    {
      title: "Part 2: €1,100 (after work permit is issued)",
      description:
...
const processingGuideData = {
  title: "Czech Republic Work Permit & Visa: Information and Processing Time",
  description:
    "Before applying for a Czech Republic work permit and visa, it’s important to understand how the process works and how long each step may take. This overview helps you plan clearly and avoid unnecessary delays.",
  cards: [
    {
      title: "Czech Republic Work Permit Processing",
      icon: Building2,
      description:
        "Work permit applications in Czech Republic are handled by (Úřad práce České republiky) based on the employer’s location.",
      duration: "35 to 45 working days",
      points: [
    ...
    {
      title: "Czech Republic Work Visa Processing",
      icon: Users,
      description:
...
const supportServicesData = {
  ...
  description:
    "EU Career Serwis supports workers throughout the full journey, from documentation and travel planning to settlement and workplace support in Czech Republic.",
  sections: [
    {
...
export default function JobsInCzechRepublic() {
  return (
    <div className="bg-white">
      <section className="px-4 pb-5 pt-5 md:pb-9 md:pt-9">
        <TopTitleBar
          name="Czech Republic"
          imageUrl="https://ik.imagekit.io/eucareerserwis/Country%20Flag/flag/Flag_of_the_Czech_Republic.svg"
        />
      </section>
