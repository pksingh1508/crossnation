...
const paymentChargePolicyData = {
  ...
  totalCharge: "Total Charge: €2,800",
  installments: [
    {
      title: "Part 1 – €300 (Prepayment to Start Processing)",
      description:
    ...
    {
      title: "Part 2 – €2,500 (After Visa Approval)",
      description:
...
export default function JobsInNorthMacedonia() {
  return (
    <div className="bg-white">
      <section className="px-4 pb-5 pt-5 md:pb-9 md:pt-9">
        <TopTitleBar
          name="North Macedonia"
          imageUrl="https://ik.imagekit.io/eucareerserwis/Country%20Flag/flag/Flag_of_North_Macedonia.svg"
        />
      </section>
